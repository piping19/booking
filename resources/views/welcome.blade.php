...
<head>
    <title>{!! $title!!}</title>
        ...
        <link href="{{asset('style2/assets/css/bootstrap.css')}}" rel='stylesheet' type='text/css' />
<!-- Custom Theme files -->
        <link href="{{asset('style2/assets/css/style.css')}}" rel='stylesheet' type='text/css' />
         <link href="{{asset('style2/assets/css/jquery-ui.css')}}" rel='stylesheet' type='text/css' />   
        <script src="{{asset('style2/assets/js/jquery-1.11.1.min.js')}}"></script>
        <script src="{{asset('style2/assets/js/bootstrap.js')}}"></script>
        <script src="{{asset('style2/assets/js/classie.js')}}"></script>
<!--webfonts-->
        <link href='//fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
        <link href='//fonts.googleapis.com/css?family=Open+Sans:400,300italic,300,600' rel='stylesheet' type='text/css'>
<!--//webfonts-->
        <script type="text/javascript" src="{{asset('style2/assets/js/classie.js')}}"></script>
  </head>
  <body>
<!-- banner -->
    <div class="banner">
        <div class="header">
            <div class="container">
                <div class="logo">
                    <h1><a href="index.html">SURFING</a></h1>
                </div>
                    <nav class="navbar navbar-default" role="navigation">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="{{url('admin')}}">Short Codes</a></li>
