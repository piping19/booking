...
<div class="animated fadeIn">
    ...
    <div class="card">
        <div class="class-header">
            ...
            <a href="{{url('programs/delete')}}" onclick="return confirm('Yakin hapus semua data permanent?')" class="btn btn-danger btn-sm">
        ...
        <tbody>
            ...
            @foreach ($programs as $item)
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href="{{url('programs/delete/'. $item->id)}}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus permanent?')">
                            Delete Permanently
                        </a>
            ...
            @else
                <tr>
                    <td colspan="" class="text-center">Data Kosong</td>
                </tr>
            @endif
        </tbody>
    </table>
