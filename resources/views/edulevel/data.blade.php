...
<div class="animated fadeIn">
    ...
    <div class="card">
        <div class="class-header">
            ...
            <a href="{{url('<!-- edulevels/trash -->')}}" class="btn btn-danger btn-sm">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <form action="{{url('edulevels/'.$item->id)}}" method="post" class="d-inline" onsubmit="return confirm('Yakin ingin hapus data?')" >
                        @method('delete')
                        @csrf
